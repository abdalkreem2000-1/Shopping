...
echo " <div class='alert alert-danger'>
    <strong>Danger!</strong> Fill in the fields.
	  ...
	  $sql = "DELETE FROM phone WHERE name = :zip";
    ...
    $stmt->execute(array(':zip' => $_POST['name']));
     $sql1 = "DELETE FROM product WHERE name = :zip";
    ...
    $stmt1->execute(array(':zip' => $_POST['name']));
         
}}
						 ?>
						 <br>
						<button   type="button" class="btn btn-outline-dark" id="formButton2">Remove a phone</button>
                                    <form method="post"  id="form2" style="display:none;" >
                                      <div class="form-group">
                                      <b>Name Phone:</b> <input class="form-control" type="text" name="name"></div>
...
echo " <div class='alert alert-danger'>
    ...
    $sql = "INSERT INTO phone (name, price, src,explained) 
    ...
    $sql1 = "INSERT INTO product (name, price, src,explained) 
              VALUES (:name, :price, :src,:explained)";
                $stmt1 = $pdo->prepare($sql1);
    $stmt1->execute(array(
        ':name' => $_POST['name'],
        ...
        ':explained' => $_POST['explained']));
							...
							?>
									...
									<button style="float: right;" type="button" class="btn btn-outline-dark" id="formButton">Add a phone</button>
                                    <br><br><center> <form method="post"  id="form1" style="display:none;" >
                                    	<div class="form-group">
                                    	<b>Name Phone:</b> <input class="form-control" type="text" name="name"></div>
                                         
                                         <div class="form-group">
                                        <b>Phone Price: </b><input type="text" class="form-control" name="price"></div>
                                       <div class="form-group"> <b>Phone Src img: </b><input class="form-control" type="text" name="src"></div>
                                       <div class="form-group">
...
foreach ( $rows as $row ) {
    echo "<div id=".$row['id']." class='product'>
							...
							<div class='product_content'>
								<div class='product_title'><a  href='product.php?name=".$row['Name']."'>".$row['Name']." </a></div>
			...
			<div class="row">
				<div class="col">
					<div class="footer_content d-flex flex-lg-row flex-column align-items-center justify-content-lg-start justify-content-center">
						<div class="footer_logo"><a href="#">Shoping.sy</a></div>
