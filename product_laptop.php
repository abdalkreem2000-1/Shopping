	...
	<div class="product_details">
		<div class="container">
			<div class="row details_row">
				...
				$stmt = $pdo->query("SELECT * FROM laptop JOIN product  ON  laptop.name=product.name ; ");
    ...
    $stmt1->execute(array(
        ...
        ':src' => $src1 ));} 
				?>
						...
						<form method="post">
						<button type='submit' name="submit1" class='btn btn-outline-dark'>Add to cart</button>		
							</form>
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2">
					<div class="newsletter_content text-center">
						...
						<div class="newsletter_text"><p>Join us to get the best phones at an affordable price</p></div>
